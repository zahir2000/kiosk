...
import 'package:kiosk/utils/tflite/recognition.dart';
import 'package:tflite_flutter/tflite_flutter.dart';
import 'package:tflite_flutter_helper/tflite_flutter_helper.dart';
import 'package:kiosk/widgets/mainContainer/main_container.dart';
...
class Classifier {
  ...
  void loadModel({Interpreter? interpreter}) async {
    try {
      ...
      INPUT_SIZE = _interpreter.getInputTensors()[0].shape[1];
